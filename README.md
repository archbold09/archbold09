...
const angel = {
    location: "Colombia 🇨🇴",
    learning: ["Web Technologies", "Design", "English"],
    askMeAbout: ["JavaScript", "Vue.js", "Frontend Dev"],
    hobbies: ["Gaming 🎮", "Coding 💻", "Learning new stuff 📚"],
    funFact: "I play League of Legends in my free time ⚔️"
};
```
